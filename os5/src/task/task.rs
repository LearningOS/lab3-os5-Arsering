...
use crate::config::{TRAP_CONTEXT, DEFAULT_PRIOR, BIG_STRIDE, MAX_SYSCALL_NUM};
...
impl Schedule {
    pub fn update_pass(&mut self) {
        ...
        if self.pass + self.stride < self.pass {
            self.pass = usize::MAX;
        }
    }
}
...
impl TaskControlBlockInner {
    ...
    */
    /// 根据self.trap_cx_ppn从物理内存中取出本task对应的trapContext
...
impl TaskControlBlock {
    ...
    pub fn new(elf_data: &[u8]) -> Self {
        ...
        // 手动查页表找到位于应用地址空间中新创建的Trap 上下文被实际放在哪个物理页帧上
            ...
            inner: unsafe {
                UPSafeCell::new(TaskControlBlockInner {
                    ...
                    schedule: Schedule {
                        ...
                        prio: DEFAULT_PRIOR,
                        pass: 0,
                        stride: BIG_STRIDE / DEFAULT_PRIOR,
                    },
